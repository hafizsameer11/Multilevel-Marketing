                    ...
                    <div class="col-md-4 mb-4">
                        <a href="#" class="card">
                            <div class="card-body">
                                ...
                                <p class="card-value">$ {{$user->userMeta->work_earning+$user->userMeta->refferal_earning}}</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4 mb-4">
                        <a href="{{route('team.earnings')}}" class="card">
                            <div class="card-body">
                                <h5 class="card-title">Team Earning</h5>
                                <p class="card-value">$ {{$user->userMeta->refferal_earning}}</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4 mb-4">
                        <a href="{{route('work.earnings')}}" class="card">
                            <div class="card-body">
                                <h5 class="card-title">Work Earning</h5>
                                <p class="card-value">$ {{$user->userMeta->work_earning}}</p>
                            </div>
                        </a>
                    </div>
                </div>
