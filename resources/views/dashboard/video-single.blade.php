...
@section('main-section')
    <style>
        ...
        .ytp-more-videos-view.ytp-scroll-min.ytp-scroll-max {
            display: none;
        }
    </style>
        ...
        <div class="m-content mx-2 mx-lg-3 px-2 px-lg-0 pb-4">
            ...
            <div class="top-contnt row mt-3 justify-content-between mb-3">
                <div class="col-md-auto col-12">
                    ...
                    <a href="{{route('video.works')}}" id="videosWork" class="btnn btn btn-dark">Videos Work</a>
                    <a href="{{route('work.previous')}}" id="previousWork" class="btnn btn btn-light">Check Previous work</a>
            ...
            <div>
                <div class="table-filter mt-4" id="videowork">
    ...
    @section('additonal-script')
        ...
        <script>
            var player;
            var currentTime = {{ $video->duration }};
            // var currentTime = 12;
            var myTimer;
                    ...
                    if (currentTime == 0) {
                        ...
                        $.ajax({
                            ...
                            error: function(xhr, status, error) {
                                console.error('Error sending video completion status:', error);
                                // Handle error
                            }
                        });
                    }
