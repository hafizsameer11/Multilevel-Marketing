        ...
        <div class="m-content mx-2 mx-lg-3 px-2 px-lg-0 pb-4">
            ...
            <div class="top-contnt row mt-3 justify-content-between mb-3">
                <div class="col-md-auto col-12">
                    ...
                    <a href="{{ route('work.earnings') }}" id="videosWork" class="btnn btn btn-light">Videos Earning</a>
                    <a href="{{ route('user.articleearnings') }}" id="previousWork" class="btnn btn btn-dark">Articel Working</a>
                </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $t)
                                    <tr class="invest-tb">
                                        ...
                                        <td class="contry">{{ $t->article->title }}</td>

                                        <td>{{ (new DateTime($t->created_at))->format('F j, Y, g:i a') }}</td>
                                        <td class="contry">{{ $t->status }}</td>
