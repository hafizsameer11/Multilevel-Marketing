                        ...
                        <tbody>
                            @foreach ($users as $t)
                                ...
                                <tr class="invest-tb">
                                    ...
                                    <td class="contry"> <a href="{{ route('user.details', ['id' => $t->id]) }}">
                                            {{ $t->username }}</a> </td>
                                    <td class="contry">{{ $t->name }} </td>
                                    <td class="contry">{{ $t->role }} </td>
                                    <td class="contry"> <a href="#" data-id="{{ $t->id }}"
                                            class="btn btn-outline-danger sender">Sender</a><a data-id="{{ $t->id }}"
                                            href="#" class="btn btn-outline-success receiver">Reciever</a>
...
@section('additonal-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            function sendingrequest(uid, role) {
                $.ajax({
