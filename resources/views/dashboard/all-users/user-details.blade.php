        ...
        <div class="m-content mx-2 mx-lg-3 px-2 px-lg-0 pb-4">
            ...
            <div class="top-contnt row mt-3 justify-content-between mb-3">
                <div class="col-md-auto col-12">
                    ...
                    <h3 class="text-dark fw-bold">User Details</h3>
                </div>
                        ...
                        <div class="banner-contnt d-flex flex-column flex-lg-row align-items-center">
                            <div
                                ...
                                <div class="bnr-txt text-white ms-2">
                                    <h3 class="fs-5 fw-bold">Username</h3>
                                    <div class="fs-6 fw-semibold">{{ $user->username }}</div>
                                </div>
                            </div>
            ...
            <div class="funds-boxes mt-4">
                <div class="row no-gutters">
                    <div class="col-lg-12 col-12 row gap-4 ">
                        ...
                        <div class="col-lg-12  fund-card fund-sp">
                            <div class="row p-0">
                                ...
                                <div class="col col-12 mt-3 pt-2">
                                    <div class="fud-crd d-flex justify-content-between align-items-center">
                                        <div class="text-light fw-semibold"> Username</div>
                                        <div class="fw-bold">{{ $currentuser->username }} </div>
                                    </div>
                                    <div class="fud-crd d-flex justify-content-between align-items-center">
                                        <div class="text-light fw-semibold"> FUll Name</div>
                                        <div class="fw-bold">{{ $currentuser->name }} </div>
                                    </div>
                                    <div class="fud-crd d-flex justify-content-between align-items-center">
                                        <div class="text-light fw-semibold"> CNIC</div>
                                        <div class="fw-bold">{{ $currentuser->cnic }} </div>
                                    </div>
                                    <div class="fud-crd d-flex justify-content-between align-items-center">
                                        <div class="text-light fw-semibold"> Address</div>
                                        <div class="fw-bold">{{ $currentuser->address }} </div>
                                    </div>
                                    <div class="fud-crd d-flex justify-content-between align-items-center">
                                        <div class="text-light fw-semibold"> Balance</div>
                                        <div class="fw-bold">{{ $currentuser->userMeta->user_balance }} $</div>
                                    </div>
                                    <div class="fud-crd mt-1 d-flex justify-content-between align-items-center">
                                        <div class="text-light fw-semibold"> Bank Name</div>
                                        <div class="fw-bold">{{ $currentuser->bankdetails->bankname }} </div>
                                    </div>
                                    <div class="fud-crd mt-1 d-flex justify-content-between align-items-center">
                                        <div class="text-light fw-semibold"> Account Holder Name</div>
                                        <div class="fw-bold">{{ $currentuser->bankdetails->accountholdername }}</div>
                                    </div>
                                    <div class="fud-crd mt-1 d-flex justify-content-between align-items-center">
                                        <div class="text-light fw-semibold">Account Number</div>
                                        <div class="fw-bold" style="text-transform: capitalize">
                                            {{ $currentuser->bankdetails->accountnumber }}</div>
                                    </div>
                                    <div class="fud-crd mt-1 d-flex justify-content-between align-items-center">
                                        <div class="text-light fw-semibold">Current Plan</div>
                                        <div class="fw-bold" style="text-transform: capitalize">
                                            {{ $currentuser->usermeta->plan->name }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
