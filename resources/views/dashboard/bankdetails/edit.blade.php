        ...
        <div class="m-content mx-2 mx-lg-3 px-2 px-lg-0 pb-4">
            ...
            <div class="top-contnt row mt-3 justify-content-between mb-3">
                <div class="col-md-auto col-12">
                    ...
                    <h3 class="text-dark fw-bold">Bank Details</h3>
                </div>
                        ...
                        <div class="fund-card fund-sp">
                            <div class="row p-0">
                                <div class="col-lg-12 col-12">
                                    ...
                                    <div class="fs-4 fw-bold">Update Bank Details</div>
                                </div>

                                <div class="col col-12 mt-3 pt-2">
                                    <form method="POST" action="{{ route('bankdetail.update') }}">
                                        @csrf
                                        <input type="hidden" name="user_id" value="{{Auth::id()}}">
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Enter BankName</label>
                                            <input type="text" name="bankname" class="form-control" id="username"
                                                aria-describedby="emailHelp" value="{{$bankdetail->bankname}}">
                                        ...
                                        @enderror
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Enter Account Holder
                                                Name</label>
                                            <input type="text" name="accountholdername" class="form-control"
                                                id="" aria-describedby="emailHelp" value=" {{$bankdetail->accountholdername}}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="accountnumber" class="form-control"
                                                id="amount" value="{{$bankdetail->accountnumber}}">
                                        </div>
                                        @error('accountnumber')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        @enderror
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">IBAN (optional)</label>
                                            <input type="number" name="iban" class="form-control" id="amount" value=" {{$bankdetail->iban}}">
