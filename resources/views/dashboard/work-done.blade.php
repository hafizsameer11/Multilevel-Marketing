        ...
        <div class="m-content mx-2 mx-lg-3 px-2 px-lg-0 pb-4">
            ...
            <div class="top-contnt row mt-3 justify-content-between mb-3">
                <div class="col-md-auto col-12">
                    ...
                    <a href="{{route('video.works')}}" id="videosWork" class="btnn btn btn-light">Videos Work</a>
                    <a href="#" id="previousWork" class="btnn btn btn-dark">Check Previous work</a>
                </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $t)
                                    ...
                                    <tr class="invest-tb">
                                        ...
                                        <td class="contry">{{ $t->videoModel->title }}</td>

                                        <td>{{ $t->videoModel->created_at }}</td>
                                        <td>Complete</td>
