         ...
         <div class="row">
            <div class="col-xl-5 col-lg-6 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".5s">
               <div class="ab-inner-content">
                  <h4 class="ab-title-xs mb-25">Who Are We?</h4>
                  ...
                  <div class="tp-inner-list">
                     <ul>
                        <li><i class="far fa-check"></i> 24/7 Backup</li>
                        <li><i class="far fa-check"></i> 6 Total Projects </li>
                        <li><i class="far fa-check"></i>99% Customer Satisfication </li>
                        <li><i class="far fa-check"></i>95% Response Rate </li>
                     </ul>
                  </div>
               </div>
            </div>
                  ...
                  <div class="row gx-3">
                     <div class="col-xl-7 col-lg-6 col-md-7 col-7">
                        <div class="ab-inner-img">
                           <img src="{{asset('web/assets/img/about/ab-inner-1.jpg')}}" alt="">
                        </div>
                     </div>
                     <div class="col-xl-5 col-lg-6 col-md-5 col-5">
                        <div class="ab-inner-img mb-20">
                           <img src="{{asset('web/assets/img/about/ab-inner-2.jpg')}}" alt="">
                        </div>
                        <div class="ab-inner-img">
                           <img src="{{asset('web/assets/img/about/ab-inner-3.jpg')}}" alt="">
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-30 wow tpfadeUp" data-wow-duration=".7s"
               ...
               <div class="counter-item text-center">
                  <h4><span class="counter">150,000</span>+</h4>
                  <h3>Total Users</h3>
               </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-30 wow tpfadeUp" data-wow-duration=".7s"
            ...
            <div class="tp-case-active">
               <div class="tp-case-item text-center p-relative mb-30">
                  <div class="tp-case-item__thumb fix">
                     <a href="case-details.html"><img src="{{asset('web/assets/img/case/case-3-1.jpg')}}" alt=""></a>
                  </div>
               ...
               <div class="tp-case-item text-center p-relative mb-30">
                  <div class="tp-case-item__thumb fix">
                     <a href="case-details.html"><img src="{{asset('web/assets/img/case/case-3-2.jpg')}}" alt=""></a>
                  </div>
                  <div class="tp-circle-text">
                     <a href="case-details.html">Case <br> Studies</a>
                  </div>
               ...
               <div class="tp-case-item text-center p-relative mb-30">
                  <div class="tp-case-item__thumb fix">
                     <a href="case-details.html"><img src="{{asset('web/assets/img/case/case-3-3.jpg')}}" alt=""></a>
                  </div>
                  <div class="tp-circle-text">
                     <a href="case-details.html">Case <br> Studies</a>
                  </div>
               ...
               <div class="tp-case-item text-center p-relative mb-30">
                  <div class="tp-case-item__thumb fix">
                     <a href="case-details.html"><img src="{{asset('web/assets/img/case/case-3-4.jpg')}}" alt=""></a>
                  </div>
                  <div class="tp-circle-text">
      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 mb-60 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".7s">
               <div class="tp-team team-inner text-center">
                  <div class="tp-team-thumb p-relative">
                     <img src="{{asset('web/assets/img/team/team-1.jpg')}}" alt="">
                     <div class="tp-team-thumb-icon">
                        <a href="about-me.html"><i class="far fa-long-arrow-right"></i></a>
                     </div>
                  </div>
                  <div class="tp-team-content">
                     <h4 class="tp-team-title"><a href="about-me.html">Adnan Zaffar </a></h4>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 mb-60 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
               <div class="tp-team team-inner text-center">
                  <div class="tp-team-thumb p-relative">
                     <img src="{{asset('web/assets/img/team/team-2.jpg')}}" alt="">
                     <div class="tp-team-thumb-icon">
                        <a href="about-me.html"><i class="far fa-long-arrow-right"></i></a>
                     </div>
                  </div>
                  <div class="tp-team-content">
                     <h4 class="tp-team-title"><a href="about-me.html">Imran Ali</a></h4>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 mb-60 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
               <div class="tp-team team-inner text-center">
                  <div class="tp-team-thumb p-relative">
                     <img src="{{asset('web/assets/img/team/team-3.jpg')}}" alt="">
                     <div class="tp-team-thumb-icon">
                        <a href="about-me.html"><i class="far fa-long-arrow-right"></i></a>
                     </div>
                  </div>
                  <div class="tp-team-content">
                     <h4 class="tp-team-title"><a href="about-me.html">Saad Shakeel</a></h4>
            ...
            <div class="testimonial-active-three">
               <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                  ...
                  <div class="tp-testimonial-three__content">
                     ...
                     <div class="tp-testimonial-three__content-text">
                        <p>Using this site to earn money feels authentic and straightforward, which I appreciate. It's user-friendly, and I'm glad they're taking steps to improve security.
                  ...
                  <div class="tp-testimonial-three__user">
                     <div class="tp-testimonial-three__user-img">
                        <img src="{{asset('web/assets/img/testimonial/testi-img-6.png')}}" alt="">
                     </div>
                     <div class="tp-testimonial-three__user-content">
                        <h4 class="user-title">Uzair Ahmad</h4>
               ...
               <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                  ...
                  <div class="tp-testimonial-three__content">
                     ...
                     <div class="tp-testimonial-three__content-text">
                        <p>"I find it reassuring that the website is transparent about how to make money. The interface is simple to use, and I'm looking forward to seeing more security features added."
                  ...
                  <div class="tp-testimonial-three__user">
                     <div class="tp-testimonial-three__user-img">
                        <img src="{{asset('web/assets/img/testimonial/testi-img-7.png')}}" alt="">
                     </div>
                     <div class="tp-testimonial-three__user-content">
                        <h4 class="user-title">Umair Javaied</h4>
                     </div>
                  </div>
               </div>
               <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                  ...
                  <div class="tp-testimonial-three__content">
                     ...
                     <div class="tp-testimonial-three__content-text">
                        <p>"I'm happy with the website's credibility and its clear explanation of earning opportunities. It's easy to navigate, and I'm eager to see further enhancements to security."
                  ...
                  <div class="tp-testimonial-three__user">
                     <div class="tp-testimonial-three__user-img">
                        <img src="{{asset('web/assets/img/testimonial/testi-img-8.png')}}" alt="">
                     </div>
                     <div class="tp-testimonial-three__user-content">
                        <h4 class="user-title">Abubakar</h4>
                     </div>
                  </div>
               </div>
               <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                  ...
                  <div class="tp-testimonial-three__content">
                     ...
                     <div class="tp-testimonial-three__content-text">
                        <p>"This site makes it easy to understand how to earn money, which builds my confidence in its legitimacy. The interface is user-friendly, and I hope they continue to prioritize security."
                  ...
                  <div class="tp-testimonial-three__user">
                     <div class="tp-testimonial-three__user-img">
                        <img src="{{asset('web/assets/img/testimonial/testi-img-9.png')}}" alt="">
                     </div>
                     <div class="tp-testimonial-three__user-content">
                        <h4 class="user-title">Hammad Younus</h4>
                     </div>
                  </div>
               </div>
               <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                  ...
                  <div class="tp-testimonial-three__content">
                     ...
                     <div class="tp-testimonial-three__content-text">
                        <p>"I trust this website to help me earn money, thanks to its transparency and clarity. It's user-friendly, and I'm pleased to see efforts to strengthen security measures."
                  ...
                  <div class="tp-testimonial-three__user">
                     <div class="tp-testimonial-three__user-img">
                        <img src="{{asset('web/assets/img/testimonial/testi-img-10.png')}}" alt="">
                     </div>
                     <div class="tp-testimonial-three__user-content">
                        <h4 class="user-title">Kamran Butt</h4>
                     </div>
                  </div>
               </div>
               <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                  ...
                  <div class="tp-testimonial-three__content">
                     ...
                     <div class="tp-testimonial-three__content-text">
                        <p>"The website's credibility and straightforward approach to earning money make me feel comfortable using it. It's easy to navigate, and I appreciate the attention to security."
                  ...
                  <div class="tp-testimonial-three__user">
                     ...
                     <div class="tp-testimonial-three__user-content">
                        <h4 class="user-title">Ali Masood</h4>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="container">
         <div class="tp-contact-wrapper p-relative">
            <div class="tp-contact-shape d-none d-xl-block">
               <img src="{{asset('web/assets/img/cta/cta-1.png')}}" alt="">
            </div>
            <div class="row">
                  ...
                  <div class="contact-info">
                     <div class="contact-info-item d-flex align-items-center">
                        <div class="contact-icon">
                           <img src="{{asset('web/assets/img/contact/contact-1.png')}}" alt="">
                        </div>
                     ...
                     <div class="contact-info-item d-flex align-items-center">
                        <div class="contact-icon">
                           <img src="{{asset('web/assets/img/contact/contact-2.png')}}" alt="">
                        </div>
                        <div class="contact-loaction">
                     ...
                     <div class="contact-info-item d-flex align-items-center">
                        <div class="contact-icon">
                           <img src="{{asset('web/assets/img/contact/contact-3.png')}}" alt="">
                        </div>
                        <div class="contact-loaction">
