...
@section('main-section')
    ...
    <main>
        ...
        <div class="tp-hero-area hero-grideant-bg"
            data-background="{{ asset('web/assets/img/slider/slider-grident-bg.png') }}">
            <div class="container">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="tp-hero">
                            <div class="tp-hero__section-box">
                                ...
                                <h2 class="tp-slider-title wow tpfadeUp" style="font-size: 40px !important"
                                    data-wow-duration=".7s" data-wow-delay=".6s">
                                    Unlock your earning potential with our team of solution experts.
                                </h2>
                                <p class="wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".8s">
                                    We have almost 12+ Years Of Experience & We offer top-notch services to help you
                                    maximize your income and achieve your financial goals.
                                </p>
                            </div>
                            <div class="tp-hero__wrapper d-flex align-items-center wow tpfadeUp" data-wow-duration=".7s"
                                data-wow-delay="1s">
                                <div class="tp-hero__button">
                                    <a class="tp-btn" href="case-studies.html">Success
                                    </a>
                                </div>
                                <div class="tp-hero__play-button">
                                    <a class="popup-video" target="_blank" href="https://youtu.be/4lQ_Wrz9j9c?si=hnh82wahY8atQr56"><i
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="tp-hero__wrapper-thumb p-relative">
                            <div class="tp-hero-shape-one">
                                <img src="{{ asset('web/assets/img/slider/hero-star-shape.png ') }}" alt="" />
                            </div>
                            <div class="tp-hero-shape-two">
                                <img src="{{ asset('web/assets/img/slider/hero-circle-shape.png ') }}" alt="" />
                            </div>
                            <div class="tp-hero-shape-three">
                                <img src="{{ asset('web/assets/img/slider/hero-angel-shape.png ') }}" alt="" />
                            </div>
                            <div class="tp-hero-shape-four">
                                <img src="{{ asset('web/assets/img/slider/hero-star-sm-shape.png ') }}" alt="" />
                            </div>
                            <div class="tp-hero__thumb text-start text-lg-end wow tpfadeRight" data-wow-duration=".9s"
                                data-wow-delay="1.2s">
                                <img src="{{ asset('web/assets/img/slider/hero-1.png ') }}" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-5 col-lg-5 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".3s">
                        <div class="tp-slider-exprience">
                            <div class="tp-slider-exprience__content">
                                <h4 class="tp-slider-exp-title">
                                    "Make more money with our experts
                                </h4>
                                <p>
                                    Our vision at Solution Experts is to empower every user to achieve financial success. By harnessing the expertise of our dedicated team, we're committed to providing innovative solutions that enable our users to maximize their earnings potential. Together, let's embark on a journey towards greater prosperity
                                </p>
                            </div>
                            <div class="tp-slider-exprience__client-info d-flex align-items-center">
                                <div class="tp-slider-exprience__img">
                                    <img src="{{ asset('web/assets/img/slider/hero-sm-img.png ') }}" alt="" />
                                </div>
                                <div class="tp-slider-exprience__meta">
                                    <h5 class="tp-client-name">
                                        David Steward
                                    </h5>
                                    <span>Founder of Experts
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-7 col-lg-7 order-1 order-lg-2 wow tpfadeRight" data-wow-duration=".7s"
                        ...
                        <div class="tp-ab-section-title-box">
                            <h4 class="tp-section-subtitle tp-green-color">
                                Who we are?
                            </h4>
                            ...
                            <p>
                                We are your well wisher and advisors we are not your boss not your any kind of order giving
                                person we just have an idea which we are sharing all over country.
                    ...
                    <div class="col-xl-5 col-lg-5 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".5s">
                        <div class="service-section-wrapper">
                            <div class="tp-service-section-title-box">
                                <h4 class="tp-section-subtitle tp-yellow-color">
                                ...
                                <p>We provide withdrawals on different style
                                    No time restrictions, no specific experience , no age limits , no work force. 24/7
                                    support team & customer care services

                                </p>
                                <ul>
                                    Weekly withdrawal. <br>
                                    15 Days withdrawal . <br>
                                    Monthly withdrawal.
                        ...
                        <div class="row service-space-left">
                            <div class="col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".7s">
                                <div class="tp-service-item mb-20 d-flex justify-content-between">
                                    <div class="tp-service-item__content">
                                        <h4 class="tp-service-sm-title">
                                            <a href="service-details.html">Digital <br />
                                                Marketing</a>
                                        </h4>
                            ...
                            <div class="col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                                <div class="tp-service-item sv-color-blue-one mb-20 d-flex justify-content-between">
                                    <div class="tp-service-item__content">
                                        <h4 class="tp-service-sm-title">
                                            <a href="service-details.html">IT <br />
                                                Services
                                            </a>
                                        </h4>
                                        <div class="tp-service-item__button-link">
                            ...
                            <div class="col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                                <div class="tp-service-item sv-color-blue-two mb-20 d-flex justify-content-between">
                                    <div class="tp-service-item__content">
                                        <h4 class="tp-service-sm-title">
                                            <a href="service-details.html">Any kind Custom <br />
                                                Solution</a>
                                        </h4>
                                        <div class="tp-service-item__button-link">
                                            <a href="service-details.html">
        ...
        <!-- tp-case-area-start -->
        <div class="tp-case-area case-bg case-space"
            data-background="{{ asset('web/assets/img/case/case-grident-shape.png ') }}">
            <div class="container">
                ...
                <div class="row gx-20">
                    <div class="col-xl-6 col-lg-6 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".5s">
                        <div class="tp-case-thumb p-relative fix mb-20">
                            <img src="{{ asset('web/assets/img/case/case-1.jpg ') }}" alt="" />
                            <div class="case-icon">
                                <a href="{{route('services')}}"><i class="fas fa-arrow-alt-up"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".7s" data-wow-delay=".7s">
                        <div class="tp-case-thumb p-relative fix mb-20">
                            <img src="{{ asset('web/assets/img/case/case-2.jpg ') }}" alt="" />
                            <div class="case-icon">
                                <a href="{{route('services')}}"><i class="fas fa-arrow-alt-up"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".9s">
                        <div class="tp-case-thumb p-relative fix mb-20">
                            <img src="{{ asset('web/assets/img/case/case-3.jpg ') }}" alt="" />
                            <div class="case-icon">
                                <a href="{{route('services')}}"><i class="fas fa-arrow-alt-up"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".7s" data-wow-delay="1s">
                        <div class="tp-case-thumb p-relative fix mb-20">
                            <img src="{{ asset('web/assets/img/case/case-4.jpg ') }}" alt="" />
                            <div class="case-icon">
                                <a href="{{route('services')}}"><i class="fas fa-arrow-alt-up"></i></a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="tp-case-button text-center mt-40">
                            <a class="tp-btn" href="{{route('services')}}">all Case studeis</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tp-testimonial-area tp-testimonial-space p-relative testimonial-border-shape"
            data-background="{{ asset('web/assets/img/testimonial/testi-border-shape.png') }}">
            <div class="container">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".7s">
                                <div class="tp-testimonial-item mb-30">
                                    ...
                                    <div class="tp-testimonial-item__text">
                                        <p>
                                            "I'm happy with the website's honesty and how it explains how to make money.
                                            It's easy to use, and I like that they're making it even safer. I hope they add
                                            more ways for us to talk to each other and make more money together."
                                    ...
                                    <div
                                        ...
                                        <div class="tp-testimonial-item__info d-flex align-items-center">
                                            <div class="tp-testimonial-item__info-img">
                                                <img src="{{ asset('web/assets/img/testimonial/testi-img-1.png') }}"
                                                    alt="" />
                                            </div>
                            ...
                            <div class="col-xl-12 col-lg-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                                <div class="tp-testimonial-item testimonial-bg-color-2 mb-30">
                                    ...
                                    <div class="tp-testimonial-item__text">
                                        <p>
                                            "As someone using the website to make money, I'm glad it feels trustworthy and shows me how to earn. It's really simple to use, and I appreciate them making it safer. I'm looking forward to them adding more ways for us users to connect and boost our earnings together."
                                    ...
                                    <div
                                        ...
                                        <div class="tp-testimonial-item__info d-flex align-items-center">
                                            <div class="tp-testimonial-item__info-img">
                                                <img src="{{ asset('web/assets/img/testimonial/testi-img-2.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="tp-testimonial-item__info-text">
                                                <h4 class="client-name">
                            ...
                            <div class="col-xl-12 col-lg-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                                <div class="tp-testimonial-item testimonial-bg-color-3 mb-30">
                                    ...
                                    <div class="tp-testimonial-item__text">
                                        <p>
                                            "As a user making money on the site, I'm happy it's genuine and clear about earning opportunities. It's user-friendly, and I appreciate efforts to enhance security. Adding more ways for us users to engage and earn together would be fantastic."
                                    ...
                                    <div
                                        ...
                                        <div class="tp-testimonial-item__info d-flex align-items-center">
                                            <div class="tp-testimonial-item__info-img">
                                                <img src="{{ asset('web/assets/img/testimonial/testi-img-3.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="tp-testimonial-item__info-text">
                                                <h4 class="client-name">
                    ...
                    <div class="col-12">
                        <div class="tp-brand-title-box pb-60">
                            <h4 class="tp-brand-title">
                                <span>Over 100+</span> Daily Withdrawals
                ...
                <div class="brand-slider-active d-flex align-items-center">
                    <div class="brand-item">
                        <div class="tp-brand-icon">
                            <img src="{{ asset('web/assets/img/brand/brand-9.png') }}" alt="" />
                        </div>
                    </div>
                    <div class="brand-item wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".7s">
                        <div class="tp-brand-icon">
                            <img style="transform: rotate(-13deg);" width="100px" src="{{ asset('web/assets/img/brand/brand-4.png') }}" alt="" />
                        </div>
                    </div>
                    <div class="brand-item wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".3s">
                        <div class="tp-brand-icon">
                            <img src="{{ asset('web/assets/img/brand/brand-2.png') }}" alt="" />
                        </div>
                    </div>
                    <div class="brand-item wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                        <div class="tp-brand-icon">
                            <img src="{{ asset('web/assets/img/brand/brand-5.png') }}" alt="" />
                        </div>
                    </div>
                    <div class="brand-item wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".5s">
                        <div class="tp-brand-icon">
                            <img src="{{ asset('web/assets/img/brand/brand-1.png') }}" alt="" />
                        </div>
                    </div>
                    <div class="brand-item wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                        <div class="tp-brand-icon">
                            <img style="    margin-top: 32px;" src="{{ asset('web/assets/img/brand/brand-7.png') }}" alt="" />
                        </div>
                    </div>
                    <div class="brand-item wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                        <div class="tp-brand-icon">
                            <img style="    margin-top: 32px;" src="{{ asset('web/assets/img/brand/brand-6.png') }}" alt="" />
                        </div>
                    </div>
        ...
        <div class="tp-blog-area blog-grident-bg blog-space"
            data-background="{{ asset('web/assets/img/blog/blog-gridient-shape.png') }}">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                    ...
                    <div class="row gx-20">
                        <div class="col-xl-6 col-lg-6 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".4s">
                            <div class="tp-blog-item mb-30">
                                <div class="tp-blog-item__thumb fix">
                                    <a href="{{route('blog')}}"><img src="{{ asset('web/assets/img/blog/blog-1.jpg') }}"
                                            alt="" /></a>
                                </div>
                                ...
                                <div class="tp-blog-item__blog-title">
                                    <h4 class="tp-blog-title-lg">
                                        <a href="{{route('blog')}}">How to Increase Your ROI
                        ...
                        <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".7s" data-wow-delay=".7s">
                            <div class="tp-blog-item mb-30">
                                <div class="tp-blog-item__thumb fix">
                                    <a href="{{route('blog')}}"><img src="{{ asset('web/assets/img/blog/blog-2.jpg') }}"
                                            alt="" /></a>
                                </div>
                                <div class="tp-blog-item__tag">
                                    <span>Design</span>
                                ...
                                <div class="tp-blog-item__blog-title">
                                    <h4 class="tp-blog-title-lg">
                                        <a href="{{route('blog')}}">ECommerce Marketing Statistics
                                            You Should Kno</a>
                                    </h4>
                                </div>
                                <div class="tp-blog-item__button">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <a href="#">
                            <div class="tp-social-item tp-dribble">
                                <span><i class="fab fa-dribbble"></i>
                                    dribbble</span>
                            </div>
                        </a>
                    </div>
